...
class KeyBindsScreen extends LitElement {
  ...
  constructor () {
    ...
    this.selected = -1
    this.keymaps = [
      { defaultKey: 'KeyW', key: 'KeyW', name: 'Hacia Adelante' },
      { defaultKey: 'KeyS', key: 'KeyS', name: 'Hacia Atras' },
      { defaultKey: 'KeyA', key: 'KeyA', name: 'Hacia Izquierda' },
      { defaultKey: 'KeyD', key: 'KeyD', name: 'Hacia Derecha' },
      { defaultKey: 'Space', key: 'Space', name: 'Salto' },
      { defaultKey: 'ShiftLeft', key: 'ShiftLeft', name: 'Agacharse' },
      { defaultKey: 'ControlLeft', key: 'ControlLeft', name: 'Correr' },
      { defaultKey: 'KeyT', key: 'KeyT', name: 'Abrir el Chat' },
      { defaultKey: 'Slash', key: 'Slash', name: 'Abrir Comandos' },
      // { defaultKey: '0', key: '0', name: 'Attack/Destroy' },
      // { defaultKey: '1', key: '1', name: 'Place Block' },
      { defaultKey: 'KeyQ', key: 'KeyQ', name: 'Soltar Items' }
