...
class PlayScreen extends LitElement {
  ...
  render () {
    return html`
      ...
      <p class="title">Unete a un Server</p>
      ...
      <main class="edit-boxes">
        ...
        <p class="extra-info-bv">Dejalo en blanco y sera seleccionada automaticamente</p>
      </main>

      <div class="button-wrapper">
        <pmui-button pmui-width="150px" pmui-label="Unete" @pmui-click=${this.onConnectPress}></pmui-button>
        <pmui-button pmui-width="150px" pmui-label="Cancelar" @pmui-click=${() => displayScreen(this, document.getElementById('title-screen'))}></pmui-button>
      </div>
    `
  }
